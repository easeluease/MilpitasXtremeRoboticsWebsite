...
const ftcWords = [
  { text: "What Is Ftc?", className: "supports-[background-clip:text]:text-transparent" },
];
        ...
        <div className="mx-auto w-full max-w-5xl">
          <div id="ftc">
            ...
            <p className={`${ibmPlexMono.className} max-w-5xl text-sm leading-7 text-zinc-300 lg:text-base`}>
              FIRST Tech Challenge (FTC), formerly known as FIRST TECH Challenge, is a robotics competition for students in grades 7–12 to compete head to head, by designing, building, and programming a robot to compete in an alliance format against other teams.
            </p>
          </div>
        </div>
      </section>
