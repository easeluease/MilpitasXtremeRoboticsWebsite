...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center" style={{ zoom: '0.9' }}>
      ...
      <div className="relative z-10 w-full bg-black">
        <div className="flex flex-col items-center space-y-32">
          ...
          <div id="about-section" className="grid grid-cols-1 lg:grid-cols-2 gap-24 px-10 lg:px-40 pb-24 lg:pb-48 w-full items-center justify-center min-h-screen">
            <motion.div
              initial={{ opacity: 0 }}
          ...
          <HeroHighlight className="px-10 space-y-8 w-full">
            <motion.h1
              initial={{
                opacity: 0,
                y: 20,
