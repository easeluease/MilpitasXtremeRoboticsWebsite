    ...
    <div className="flex min-h-screen flex-col items-center">
      ...
      <div className="relative z-10 w-full bg-[#0A0A0A] overflow-visible">
        <div className="flex flex-col items-center space-y-0">
          ...
          <div
            id="about-section"
            className="sticky top-0 z-0 flex flex-col items-center justify-center py-15 lg:py-25 w-full px-10 lg:px-40 min-h-screen pb-186 overflow-hidden"
          >
            <div
              aria-hidden
            ...
            <div className="relative z-10 max-w-4xl">
              ...
              >
                <TypewriterEffect
                  ...
                  className="justify-center text-5xl lg:text-6xl font-bold"
                />
              </motion.div>
          ...
          {/* SECTION 3: Programs */}
          <motion.div className="relative z-20 mt-[30vh] flex flex-col items-center justify-center pb-20 w-full px-10 lg:px-40 space-y-20 bg-[#0A0A0A] pt-20">
            <motion.div
            ...
            >
              <TypewriterEffect
                ...
                className="justify-center bg-linear-to-r from-[#b2c4ff] to-white bg-clip-text text-5xl lg:text-6xl font-bold leading-[1.15] pb-2"
              />
            </motion.div>
            ...
            >
              <div className="flex flex-col justify-start space-y-6 pt-0">
                <div className="text-9xl font-bold text-[#A1A1AA] -mb-8 leading-none">
                  01
                </div>
                <div>
                  <TypewriterEffect
                    words={vexTypewriterWords}
                    className="justify-start whitespace-nowrap bg-linear-to-r from-[#b2c4ff] to-white bg-clip-text text-3xl lg:text-4xl font-bold mb-6 text-left"
                  />
                  <div
                    className={`${ibmPlexMono.className} text-[#A1A1AA] leading-relaxed text-base`}
                  >
                    <LinkPreview
              ...
              <div className="order-2 flex flex-col justify-start space-y-6 pt-0 z-10">
                ...
                <div>
                  <TypewriterEffect
                    ...
                    className="justify-start text-left bg-linear-to-r from-[#b2c4ff] to-white bg-clip-text text-3xl lg:text-4xl font-bold mb-6"
                  />
                  <div
                    className={`${ibmPlexMono.className} text-[#A1A1AA] leading-relaxed text-base`}
                  >
              ...
              <div className="flex flex-col justify-start space-y-6 pt-0">
                ...
                <div>
                  <TypewriterEffect
                    ...
                    className="justify-start w-full bg-linear-to-r from-[#b2c4ff] to-white bg-clip-text text-left text-3xl lg:text-4xl font-bold mb-6"
                  />
                  <p
                    className={`${ibmPlexMono.className} text-[#A1A1AA] leading-relaxed text-base`}
                  >
            ...
            <Link href="/sponsors" className="hidden lg:flex">
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-blue-400 w-140 h-1"
                ></motion.div>
              </motion.div>
            </Link>
          ...
          <footer className="relative z-30 w-full bg-[#0B0B0D] border-t border-zinc-800/70">
            <div className="mx-auto w-full max-w-7xl px-4 py-4 lg:py-5">
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                <span
                  className={`${ibmPlexMono.className} text-sm text-[#A1A1AA] sm:text-center`}
                >
